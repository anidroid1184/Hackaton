...
Ultra Think mode enables deep, multi-dimensional analysis and problem-solving for complex challenges. This command activates enhanced analytical thinking that explores problems from technical, business, user, and system perspectives.

**When to use**:

- Complex architectural decisions
- Strategic planning and technology choices
- Multi-faceted problem solving
- Design challenges requiring comprehensive analysis
- Situations where multiple perspectives are critical

**What it does**:

- Analyzes problems from multiple dimensions
- Generates multiple solution approaches
- Provides deep-dive analysis with risk assessment
...
2. **Parse the Problem or Question**
   ...
   - Extract the core challenge from the provided arguments
