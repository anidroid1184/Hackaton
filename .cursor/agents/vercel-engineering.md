...
description: React and Next.js performance optimization reference. Use when maintaining, generating, or refactoring React/Next.js code. Contains 40+ rules across waterfalls, bundle size, server/client performance.
